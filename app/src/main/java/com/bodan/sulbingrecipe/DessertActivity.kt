...
class DessertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dessertList = arrayListOf(
            ...
            DessertRecycler("https://postfiles.pstatic.net/MjAyMjAzMzBfMjc0/MDAxNjQ4NjM5NTI2OTgy.Kg3kSHkfgNE83dxxtqSl7fBRs0TsLvBpG3v50zV1DDwg.oF6Dav3Vo6ZR0KYiYnzjDTC1kTM_6bDaG0zpT382J0og.PNG.littlesam95/baconcreamspaghetti.png?type=w580", 30),
